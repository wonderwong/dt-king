...
// admin testimonials list thumbnail column action
/*function dt_a_testimonials_col_thumb($column_name, $id){
	if( 'dt_testimonials_thumbs' === $column_name ){
...
add_action('manage_posts_custom_column', 'dt_a_testimonials_col_thumb', 5, 2);
 */
