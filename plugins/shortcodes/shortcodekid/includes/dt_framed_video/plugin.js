(function() {
	var command_name = 'dt_mce_command-video';
    var plugin_name = 'dt_mce_plugin_shortcode_video';
	...
	// Register plugin
	tinymce.PluginManager.add( plugin_name, tinymce.plugins.dt_mce_plugin_shortcode_video );
