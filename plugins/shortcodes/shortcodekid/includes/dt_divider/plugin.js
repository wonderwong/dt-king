(function() {
    ...
    var plugin_name = 'dt_mce_plugin_shortcode_divider';
		...
		init : function( ed, url ) {
			...
			ed.addCommand(command_name, function() {
				ed.windowManager.open({
					...
					height : 156 + ed.getLang( plugin_name + '.delta_height', 0 ),
					inline : 1
	...
	// Register plugin
	tinymce.PluginManager.add( plugin_name, tinymce.plugins.dt_mce_plugin_shortcode_divider );
