...
<head>
    ...
    function init() {
        ...
        jQuery.post(
            ...
            function( response ){
                ...
                if( (temp2 = temp.match(/(showdesc)=["']*(.*?)["'\s\/\]]+/i)) != null ) {
                ...
                if( (temp2 = temp.match(/(autoslide)=["']*(.*?)["'\s\/\]]+/i)) != null ) {
                ...
                if( (temp2 = temp.match(/(column)=["']*(.*?)["'\s\/\]]+/i)) != null ) {
	...
	function insertShortcode() {
        ...
        tagtext = '[dt_portfolio title="' + title + '" ppp="' + ppp + '" orderby="' + orderBy + '" order="' + order + '" column="' + column + '" autoslide="' + autoslide + '" showdesc="' + showdesc + '"' + filter + '/]';	
