(function() {
	var command_name = 'dt_mce_command-photos';
    var plugin_name = 'dt_mce_plugin_shortcode_photos';
	...
	// Register plugin
	tinymce.PluginManager.add( plugin_name, tinymce.plugins.dt_mce_plugin_shortcode_photos );
