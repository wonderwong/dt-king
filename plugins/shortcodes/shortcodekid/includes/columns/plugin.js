(function() {
    ...
    var plugin_name = 'dt_mce_plugin_shortcode_columns';
		...
		init : function( ed, url ) {
			...
			ed.addCommand(command_name, function() {
				...
				ed.windowManager.open({
					...
					height : 398 + ed.getLang( plugin_name + '.delta_height', 0 ),
					inline : 1
			...
			ed.addButton( plugin_name, {
				...
				title : 'Columns',
				cmd : command_name,
				image : url + '/images/sc-columns.png'
	...
	// Register plugin
	tinymce.PluginManager.add( plugin_name, tinymce.plugins.dt_mce_plugin_shortcode_columns );
