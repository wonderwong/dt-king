(function() {
    ...
    var plugin_name = 'dt_mce_plugin_shortcode_accordion';
	...
	// Register plugin
	tinymce.PluginManager.add( plugin_name, tinymce.plugins.dt_mce_plugin_shortcode_accordion );
