	...
	tinymce.create( 'tinymce.plugins.' + plugin_name, { 
			...
			switch (n) {
				...
				case 'dt_createColumn': 
					var c = cm.createMenuButton('dt_createColumn', {
						...
						image : url + '/dt_create-column.png',
						icons : false
					});
				...
				case 'dt_removeColumn': 
					var c = cm.createMenuButton('dt_removeColumn', {
						...
						image	: url + '/dt_remove-column.png',
						icons	: false,
						onclick	: function() {
							t._register_formats();
							tinyMCE.activeEditor.formatter.remove('dt_half');
		...
		_register_formats: function() {
			tinymce.activeEditor.formatter.register(
				...
				'dt_half',
				{block: 'div', collapsed : false, classes: 'half dt_col', wrapper : true, merge_siblings : false}
			);
			tinymce.activeEditor.formatter.register(
				'dt_one-third',
				{block: 'div', collapsed : false, classes: 'one-third dt_col', wrapper : true, merge_siblings : false}
			);
			tinymce.activeEditor.formatter.register(
				'dt_two-thirds',
				{block: 'div', collapsed : false, classes: 'two-thirds dt_col', wrapper : true, merge_siblings : false}
			);
			tinymce.activeEditor.formatter.register(
				'dt_one-fourth',
				{block: 'div', collapsed : false, classes: 'one-fourth dt_col', wrapper : true, merge_siblings : false}
			);
			tinymce.activeEditor.formatter.register(
				'dt_three-fourth',
				{block: 'div', collapsed : false, classes: 'three-fourth dt_col', wrapper : true, merge_siblings : false}
			);
        }
