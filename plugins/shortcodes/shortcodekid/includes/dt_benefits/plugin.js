(function() {
    ...
    var plugin_name = 'dt_mce_plugin_shortcode_benefits';
	...
	// Register plugin
	tinymce.PluginManager.add( plugin_name, tinymce.plugins.dt_mce_plugin_shortcode_benefits );
