...
class JPB_Visual_Shortcodes {
	 ...
	 */
	function styles() {
		wp_enqueue_style('jpb_visualshortcodes', DT_PLUGINS_URL . '/shortcodes/visual-shortcodes/buttons.css');
	}
	...
	function plugins($plugins) {
		$plugins['visualshortcodes'] = DT_PLUGINS_URL . '/shortcodes/visual-shortcodes/visualshortcodes/editor_plugin.js';
		return $plugins;
	}
